...
namespace ClinicManagement1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public PartialViewResult ProductList(int? page,int? pagenumber ,int ? category, List<Product> listProducts)
        {
            ...
            {
                products = db.Products.OrderBy(x => x.ProductName).ToList();
                ViewBag.products = products;
            }
        ...
        public ActionResult SanPhamNoiBat(int? skip, int? categoryid, List<Product> listProducts)
        {
            ...
            {
                products = db.Products.Where(/*x => x.CategoryId == categoryid &&*/ x=>x.View != null).OrderByDescending(x => x.View).ToList();
            }
